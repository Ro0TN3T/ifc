...
scanlist:
    ...
    echo $bold . $blue . "
+-----------------------------------------+
           Code: by Risky Channel                                                     +-----------------------------------------+

$lblue Wabsite Target -> : " . $fgreen . $ipsl . $ip . $blue . "
      \n\n";
    ...
    if (!in_array($scan, array(
    ...
    else
      {
        ...
        elseif ($scan == 'U' || $scan == 'u')
          {
            ...
            if ($latestversion > $rhversion)
              {
                echo $bold . $fgreen . "\n\n[U] Update Available, Please Update Your Version Of IFC \n" . $cln;
                echo $bold . $white . "    Link: https://github.com/Tuhinshubhra/IFC\n\n" . $cln;
              }

            elseif ($rhversion == $latestversion)
              {
                echo $bold . $fgreen . "\n[i] You are already running the latest version of IFC. \n\n" . $cln;
              }
            else
              {
        ...
        elseif ($scan == "F" || $scan == "f"){
          ...
          echo $bold . $fgreen . "[i] Job finished successfully! Please Restart IFC  \n";
          exit;
        }
